...
public class TelnetCodecTest {
    ...
    public void testDecode_Person_ObjectOnly() throws IOException {
        testDecode_assertEquals(new NewPerson(), Codec2.DecodeResult.NEED_MORE_INPUT);
    }
    ...
    //======================================================
    public static class NewPerson implements Serializable {
		private static final long serialVersionUID = -3021331852492646499L;
		public String name;
        public String sex;
		...
		public String toString() {
			return "NewPerson [name=" + name + ", sex=" + sex + "]";
		}
